          ...
          {mainTab === "add" ? (
            ...
            <div className="data-update-scroll">
                  ...
                  <ul className="data-update-group-list">
                    {catalog.map((g) => (
                      <li key={g.id} className="data-update-group-item">
                        <span className="data-update-group-item-label">
                          {g.label} ({g.fields.length})
                        </span>
                        <button type="button" className="text-btn" onClick={() => removeGroup(g.id)}>
                          Remove
                        </button>
                      </li>
                    ))}
              ...
              {modifyTab === "modify_field" ? (
                <section className="data-update-card">
                  <p className="section-hint">Assign unassigned numeric layer fields to a group.</p>
