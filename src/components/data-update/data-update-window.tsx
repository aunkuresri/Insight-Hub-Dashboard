 ...
 * in any indicator group (and not admin name/code fields).
 */
function collectUndefinedFields(catalog: IndicatorGroup[]): IndicatorField[] {
  ...
  for (const layer of map.featureLayers()) {
    for (const f of layer.fields ?? []) {
      ...
      const info: FieldInfo = { name, alias: f.alias || name, type: f.type };
      if (!isNumericField(info)) continue;
            ...
            <>
              ...
              {modifyTab === "add_field" ? (
                <section className="data-update-card">
                  ...
                  <p className="section-hint" style={{ marginTop: 0 }}>
                    Create a new attribute on the Boundary and Chart layers and register it in an
                    indicator group.
                  </p>
                  ...
                  <div className="data-update-inline-actions">
                    <button
                      type="button"
              ...
              {modifyTab === "modify_field" ? (
                <section className="data-update-card data-update-card--flat">
                  ...
                  <div className="data-update-group-block">
                    <div className="section-head">
              ...
              {modifyTab === "modify_group" ? (
                <section className="data-update-card">
                  ...
                  <ul className="data-update-field-list" role="list">
                    {catalog.map((g) => (
                      <li key={g.id} className="data-update-field-row" role="listitem">
                        <div>
                          <span className="data-update-field-row-label">{g.label}</span>
                          <span className="method-tag" style={{ marginLeft: 8 }}>
