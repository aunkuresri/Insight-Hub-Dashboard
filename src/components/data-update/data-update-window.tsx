    ...
    <div className="analytics-modal-root" role="presentation">
      ...
      <div className="data-update-modal" role="dialog" aria-modal="true" aria-label="Manage Data">
        ...
        <div className="data-update-body">
          <div className="seg data-update-maintabs" role="tablist" aria-label="Manage Data sections">
            <button
              type="button"
          ...
          {mainTab === "add" ? (
            ...
            <>
              <div className="seg data-update-subtabs" role="tablist" aria-label="Modify Data sections">
                <button
                  type="button"
